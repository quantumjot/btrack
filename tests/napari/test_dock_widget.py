...
def test_reset_button(track_widget):
    ...
    original_optimise = track_widget.optimise.isChecked()
    ...
    track_widget.optimise.setChecked(not track_widget.optimise.isChecked())
    ...
    new_optimise = track_widget.optimise.isChecked()
